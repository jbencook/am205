...
It is important to recognize that the rating matrix contains both signal and noise.
...
Many of the most popular collaborative filtering methods either use singular value decomposition (SVD) or are SVD inspired.
...
These variations handle the sparse matrix more effectively \citep{kurucz2007methods}, add regularization to prevent overfitting \citep{zhou2008large}, and merge multiple methods and information about the problem to improve the recommendations \citep{bell2007bellkor}.
...
\begin{center}
%\framebox[4.0in]{$\;$}
\fbox{\includegraphics[width=.7\textwidth]{../images/rmse_3000x1000}}
...
\begin{center}
%\framebox[4.0in]{$\;$}
\fbox{\includegraphics[width=.7\textwidth]{../images/ortho_3000x1000}}
%\fbox{\includegraphics{../scatter_results}}
\end{center}
...
\begin{center}
%\framebox[4.0in]{$\;$}
\fbox{\includegraphics[width=.7\textwidth]{../images/reconstruct_fro_3000x1000}}
%\fbox{\includegraphics{../scatter_results}}
\end{center}
